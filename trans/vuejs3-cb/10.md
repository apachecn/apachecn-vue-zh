...
有关 Netlify 路由器重写的更多信息，请访问[https://docs.netlify.com/routing/redirects/rewrites-proxies/#history-pushstate 和单页应用](https://docs.netlify.com/routing/redirects/rewrites-proxies/#history-pushstate-and-single-page-apps)。
...
然后，我们配置要使用单页应用路由器结构，并在`package.json`中添加了部署脚本。最后，我们能够部署我们的应用并使其对每个人都可用。
