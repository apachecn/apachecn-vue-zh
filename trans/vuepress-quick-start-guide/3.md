...
为了清晰和避免混淆，我们将在讨论 VuePress 自定义主题的章节中讨论与主题相关的配置。类似地，我们将在有关 VuePress 中Markdown的章节中返回讨论与 Markdown 相关的配置值。
...
好了，就这样！现在，您已经了解了 VuePress 中所有必需配置实体的基本细节。再次，我们省略了与主题配置相关的配置术语，以及Markdown，我们将在后面的章节中讨论。
...
此代码将确保引用坚持到指定的文件，而不管您使用 VuePress 的基本 URL 是什么。您可以使用它来处理公共文件，甚至可以在主题组件和Markdown 文件中使用它。
