...
如果您发现自己陷入了这些术语的困境，请记住，Vue.js 转换特性对于 Vue.js 应用程序开发来说是最重要的。在最初的例子让我演示了 Vue.js 特性是如何工作的之后，我没有直接使用 CSS 特性，而是依赖第三方包来提供向用户显示的效果。我建议您在自己的项目中也这样做，因为与尝试直接使用 CSS 过渡、动画和变换功能创建自己的复杂效果相比，结果更可预测，也更少令人沮丧。
