...
在上一章中，我们研究了Babel在现代 JavaScript 开发中的作用。我们还看到了在 Vue 中使用它的一些实际示例。在本章中，我们将介绍 JS 中的测试。我们将大致熟悉测试，并使用 Jest 和 Cypress 在实践中看到它。我们将讨论断言和**测试驱动开发**（**TDD**）。然后，我们将继续了解 Jest 和 Cypress 如何与 Vue CLI 3 一起工作。我们将讨论测试用例和测试用例。具体来说，我们将了解以下内容：
