...
[第四章](04.html#12AK81-449ee41b57ea4c048225480b41c8dbe3 "Chapter 4. Let It Pomodoro!")*让它去Pomodoro！*介绍了 Vue.js 应用程序使用 Webpack 加载程序的引导阶段。它将基本功能添加到 Pomodoro 计时器中。它还解释了如何使用引导的网格以及基本的 Vue.js 指令。
