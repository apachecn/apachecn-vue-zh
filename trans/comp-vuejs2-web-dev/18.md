...
在本教程中，您将了解构建大型应用程序时 Vuex 的基本原理。这个配方有点不合常规，因为要了解 Vuex 的商店是如何工作的，我们将直接操作它；在实际应用程序中，您永远不应该这样做。
...
![](assets/95c7b7aa-c82a-487c-b2a0-ef250352da04.png)
...
![](assets/19f87abf-9a68-4259-8bfc-55d060a5fce4.png)
